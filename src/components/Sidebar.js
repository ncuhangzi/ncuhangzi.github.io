...
import {faLinkedinIn, faGithub, faFacebook, faMedium} from "@fortawesome/free-brands-svg-icons";
    ...
    render() {
        return (
            <ButtonGroup vertical>
                <a href="https://www.linkedin.com/in/fan-chi-yeh" target="_blank"> <FontAwesomeIcon icon={faLinkedinIn} size="lg"/> </a>
                <a href="https://github.com/ncuhangzi" target="_blank">< FontAwesomeIcon icon={faGithub} size="lg"/> </a>
                <a href="https://medium.com/@st30201" target="_blank">< FontAwesomeIcon icon={faMedium} size="lg"/> </a>
